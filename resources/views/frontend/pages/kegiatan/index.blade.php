        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <p class="lead">Kegiatan SMAIT Al-Ghozali</p>
                </div>
            </div><!-- end title -->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-4">
                        <div class="blog-item">
                            <div class="image-blog">
                                <img src="{{ $item->gambar_kegiatan ?? asset('assets/frontend/images/blog_1.jpg') }}"
                                    alt="" class="img-fluid">
                            </div>
                            ...
                            <div class="blog-title">
                                <h2><a href="#" title="">{{ $item->nama_kegiatan }}</a></h2>
                            </div>
                            <div class="blog-desc">
