...
@section('content')
    ...
    <div class="all-title-box">
        <div class="container text-center">
            <h1>Detail Program Unggulan<span class="m_1">SMAIT Al-Ghozali Jember</span></h1>
            </h1>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-9 blog-post-single">
                    <div class="blog-item">
                        <div class="image-blog">
                            <img src="{{ $program->foto ?? '' }}" alt="" class="img-fluid"
                        ...
                        <div class="post-content">
                            {{-- <div class="post-date">
                                <span class="day">{{ $program->created_at->format('d') ?? '' }}</span>
                                <span class="month">{{ $program->created_at->format('M') ?? '' }}</span>
                            </div>
                            <div class="meta-info-blog">
                                <span><i class="fa fa-calendar"></i> <a
                                        href="#">{{ $program->created_at->format('d M Y') ?? '' }}</a></span>
                            </div> --}}
                            <div class="blog-title">
                                <h2><a href="#" title="">{{ $program->nama_program ?? '' }}</a></h2>
                            </div>
                            <div class="blog-desc">
                                {{-- <p>{{ strip_tags($program->deskripsi) ?? '' }}</p> --}}
                    ...
                    <div class="comments-form">
                        ...
                        <div class="comment-form-main">
                            <form action="{{ route('frontend-program.komentar', $program->id) }}" id="commentform"
                ...
                <div class="col-lg-3 col-12 right-single">
                    ...
                    <div class="widget-categories">
                        <h3 class="widget-title">Program Unggulan Terbaru</h3>
                        <ul>
                            @forelse ($semuaProgram as $item)
                                <li>
                                    <a
                                        href="{{ route('frontend-program-unggulan.show', $item->id) }}">{{ $item->nama_program }}</a>
                                </li>
                            @empty
                                <li><a href="#">Belum ada data program.</a></li>
                            @endforelse
                        </ul>
                    </div>
                    {{-- <div class="widget-tags">
                        <h3 class="widget-title">Tags Program Unggulan</h3>
                        <ul class="tags">
