    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('beranda*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('beranda.index') }}"><i class="fas fa-home"></i>
                    <span>Beranda</span></a>
            </li>
            ...
            <li class="{{ Request::is('motto-tujuan*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('motto-tujuan.index') }}"><i class="fas fa-handshake"></i>
                    <span>Motto & Tujuan</span></a>
            </li>
            <li class="{{ Request::is('sambutan*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('sambutan.index') }}"><i class="fas fa-user"></i>
                    <span>Sambutan Kepala</span></a>
            </li>
            <li class="{{ Request::is('pengajar*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('pengajar.index') }}"><i class="fas fa-users"></i>
