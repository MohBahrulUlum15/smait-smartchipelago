...
<nav class="navbar navbar-expand-lg main-navbar">
        ...
        <div class="search-element">
            ...
            <div class="search-result">
                ...
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded" width="30"
                            src="{{ asset('assets/backend/img/products/product-3-50.png') }}" alt="product">
                ...
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded" width="30"
                            src="{{ asset('assets/backend/img/products/product-2-50.png') }}" alt="product">
                        Drone X2 New Gen-7
                    </a>
                </div>
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded" width="30"
                            src="{{ asset('assets/backend/img/products/product-1-50.png') }}" alt="product">
                        Headphone Blitz
                    </a>
                </div>
                <div class="search-header">
    ...
    <ul class="navbar-nav navbar-right ml-auto">
        {{-- <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div class="dropdown-list-content dropdown-list-message">
                    ...
                    <a href="#" class="dropdown-item dropdown-item-unread">
                        <div class="dropdown-item-avatar">
                            <img alt="image" src="{{ asset('assets/backend/img/avatar/avatar-3.png') }}"
                                class="rounded-circle">
                            <div class="is-online"></div>
                        </div>
                        <div class="dropdown-item-desc">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                ...
                <div class="d-sm-none d-lg-inline-block">{{ Auth::user()->name ?? 'Username' }}</div>
            </a>
