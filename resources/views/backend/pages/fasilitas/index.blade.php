        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Fasilitas Sekolah</div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="float-right mb-2">
                                    <div class="d-flex mx-3 justify-content-end">
                                        <a href="{{ route('fasilitas.create') }}" class="btn btn-primary">Tambah Fasilitas
                                        </a>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    ...
                                    <table id="myDataTable" class="table table-hover table-sm" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                                <div class="alert alert-info alert-dismissible show fade mx-3">
