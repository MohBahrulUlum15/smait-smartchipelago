        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Karya Sekolah</div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="float-right mb-2">
                                    <div class="d-flex mx-3 justify-content-end">
                                        <a href="{{ route('karya.create') }}" class="btn btn-primary">Tambah Karya
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            @forelse ($data as $item)
                                                <tr class="align-middle">
                                                    <th class="text-center align-middle">
                                                        {{ $loop->iteration }}</th>
                                                    <td class="align-middle">{{ $item->judul_karya }}</td>
                                                    <td class="align-middle text-center">
                                                        @if ($item->gambar_karya)
                                                            <div class="d-flex justify-content-center">
                                                                <div style="width: 80px; height: 60px; overflow: hidden;">
                                                                    <img src="{{ asset($item->gambar_karya) }}"
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="d-flex justify-content-center">
                                                            ...
                                                            <form action="{{ route('karya.destroy', $item->id) }}"
