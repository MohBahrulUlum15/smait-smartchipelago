        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-back">
                    <a href="{{ route('karya.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                </div>
                <h1>Edit Karya</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                    <div class="breadcrumb-item"><a href="#">Karya</a></div>
                    <div class="breadcrumb-item">Edit Karya</div>
                </div>
            </div>
            <div class="section-body">
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('karya.update', $data->id) }}" method="post"
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" class="form-control" name="judul_karya"
                                                value="{{ $data->judul_karya ?? old('judul_karya') }}" required>
                                            @error('judul_karya')
                                                <strong class="fw-bold d-block text-danger mt-2">
                                                    <small>&nbsp;* {{ $message }}</small>
                                                </strong>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            ...
                                            @enderror
                                            <textarea class="summernote-simple form-control" name="deskripsi_karya" required>{{ $data->deskripsi_karya ?? old('deskripsi_karya') }}</textarea>
                                        </div>
                                    </div>
